...
const faqs = ref([
  ...
  },
  {
    ...
    answer: 
      'На данный момент в нашем магазине можно выбрать только оплату при получении. Ваш заказ прибудет в ближайший к вам пункт выдачи, в котором необходимо будет совершить оплату.',
    isOpen: false
  },
  {
    id: 4,
    ...
    answer:
      'После отправки заказа мы вышлем вам на электронную почту информацию, содержащую трек-номер, а также ссылку на сайт курьерской службы СДЭК, где можно будет отследить перемещение вашего заказа. В случае, если статус посылки не меняется более недели, пожалуйста, позвоните в ближайшее отделение курьерской службы СДЭК или Почта России и уточните дополнительную информацию.',
    isOpen: false
  },
  {
    id: 5,
